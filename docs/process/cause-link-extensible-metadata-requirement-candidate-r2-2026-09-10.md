# Cause Link extensible metadata requirement candidate revision 2 — 2026-09-10
...
- Proposed review input:
  [`cause-link-extensible-metadata-requirement-review-input-r2-2026-09-10.md`](cause-link-extensible-metadata-requirement-review-input-r2-2026-09-10.md)
- Previous candidate:
  [`cause-link-extensible-metadata-requirement-candidate-2026-09-10.md`](cause-link-extensible-metadata-requirement-candidate-2026-09-10.md)
- Revision basis: the owner selected `REVISE` after the completed independent
  review of revision 1; revision 2 resolves only finding F-01
...
5. Structural Cause/Revision edge membership, staleness, history, and admission
   are derived without interpreting metadata namespace, schema, or value, and
   cannot be weakened by an unknown namespace. Because metadata is
   identity-bearing, changing it may change ProvenanceID, SealID,
   assertion-source identities, comparison output, and other exact output bytes;
   semantic non-interpretation does not require byte-identical output.
...
- **Revision scope:** Revision 2 preserves revision 1 except for candidate
  identity/review routing and the clarification of acceptance criterion 5. It
  separates graph-semantic non-interpretation from identity and output-byte
  changes, resolving independent-review finding F-01 without adopting optional
  findings F-02 through F-05 as new requirements.

...
- [`adr/0040-origin-trace-occurrence-listing-and-paging.md`](adr/0040-origin-trace-occurrence-listing-and-paging.md) — Proposed: Accepted R3 と ADR 0039 に基づく一致位置一覧の CLI、版固定ページング、新しい出力 schema。採用・Seal は未決。
